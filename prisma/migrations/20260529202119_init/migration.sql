-- CreateEnum
CREATE TYPE "EmployeeRole" AS ENUM ('OPERADOR', 'ADMINISTRADOR');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('BORRADOR', 'RECIBIDO', 'EN_PREPARACION', 'LISTO', 'TERMINADO');
...
-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_operadorId_fkey" FOREIGN KEY ("operadorId") REFERENCES "employees"("id") ON DELETE SET NULL ON UPDATE CASCADE;
